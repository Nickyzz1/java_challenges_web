...
public class PasswordValidatorTests {
    ...
    void validateBigPasswords() {
        assertEquals(MyPasswordValidator.Validate("minhasenha123@"), false);
    ...
    @Test
    void validateCorrectsPassowrds() {
        assertEquals(MyPasswordValidator.Validate("minhasenhaMinha12@"), true);
    }
}